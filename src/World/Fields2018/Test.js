        ...
        (svg) => {
            ...
            data.forEach(function (e, i) {
                d3.select('#code' + e.country)
                    ...
                    .attr('fill', quantile(+e.information)) // scaleSqrt
        ...
        <Box sx={{ padding: '20px 40px', bgcolor: '#4b4957' }}>
            <Box mb={'28px'}>
                ...
                <Typography variant="body1" gutterBottom sx={{ color: '#c69b7b' }}>
                    La médaille Fields est (avec le prix Abel) une des deux plus prestigieuses récompenses en
                    mathématiques. Toutes deux sont considérées comme équivalentes à un prix Nobel inexistant pour cette
                    discipline.
                </Typography>
            </Box>
            <Box
